...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <h2 class="page-header">Review Applications</h2>
        ...
        include('connection.php');
          ...
          <div class='box box-widget widget-user'>
            <div class='widget-user-header bg-aqua-active'>
              ...
              <h5 class='widget-user-desc'>11th Commerce</h5>
            </div>
            ...
            <div class='box-footer'>
              <div class='row'>
                <div class='col-sm-4 border-right'>
                  <div class='description-block'>
                    ...
                    <span class='description-text'>Academics</span>
                  </div>
                </div>
                <div class='col-sm-4 border-right'>
                  <div class='description-block'>
                    <h5 class='description-header'>".$row['acadscore']."</h5>
                    <span class='description-text'>Financial</span>
                  </div>
                </div>
                <div class='ol-sm-4'>
                  <div class='description-block'>
             ...
             <div class='box-footer'>
              <div class='row'>
                ...
                <div class='col-sm-4 border-right'>
                  <div class='description-block'>
                    <a href='../../profile.php?id=".$row['id']."'><button class='btn btn-primary' >View</button>
                  </div>
                </div>
