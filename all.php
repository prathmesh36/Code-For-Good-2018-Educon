                  ...
                  ?>
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <?php
                          			if(file_exists('images/users/'.$messrows["sen_id"].'.jpg'))
                          	        {
                          	         echo'<img src="images/users/'.$messrows["sen_id"].'.jpg"  class="img-circle" alt="User Image">';

                          	        }else
                          	        {
                                	     echo'<img src="images/users/default.jpg" class="img-circle" alt="User Image">';
