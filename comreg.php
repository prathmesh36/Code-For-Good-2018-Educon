          ...
          <div class="form-box" >
            ...
            <div class="form-bottom" style="display:<?php if(($_GET['redirect'])=='reg'){echo'none';}?>;">
                <form role="form" action="login_reg_scripts/proreg.php" method="post" class="registration-form">
                  ...
                  <div class="form-group">
                    <label class="sr-only" for="form-first-name">Registration No</label>
                      <input type="text" name="regno" placeholder="Reg No..." class="form-first-name form-control" id="form-first-name">
                  </div>
